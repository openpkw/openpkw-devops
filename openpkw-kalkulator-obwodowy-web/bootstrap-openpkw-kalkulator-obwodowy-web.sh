...
sudo cp /vagrant/openpkw-kalkulator-obwodowy-web/.ssh/authorized_keys /home/openpkw-cd/.ssh/authorized_keys
...
sudo cp /vagrant/openpkw-kalkulator-obwodowy-web/etc/apache2/sites-available/openpkw-kalkulator-obwodowy-web.conf /etc/apache2/sites-available/openpkw-kalkulator-obwodowy-web.conf
